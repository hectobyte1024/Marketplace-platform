...
export const onBookingConfirmed = (callback: (data: any) => void) => {
  if (socket) {
...
export const onBookingUpdated = (callback: (data: any) => void) => {
  if (socket) {
...
export const onAvailabilityUpdated = (callback: (data: any) => void) => {
  if (socket) {
